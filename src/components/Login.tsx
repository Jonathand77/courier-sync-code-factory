        ...
        <div className="w-full md:w-1/2 h-full p-8 flex flex-col justify-center animate-fade-in">
          ...
          <div className='w-full h-full flex flex-col justify-center items-center'>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-2xl md:text-3xl font-extrabold text-indigo-600 tracking-tight">CourierSync</h1>
            </div>

            <h2 className="text-xl md:text-2xl font-bold text-indigo-600 mb-2 transition-colors duration-300 hover:text-indigo-700">
              Inicio de sesión
            </h2>
            ...
            <div className="flex justify-center mt-6">
              <button
                ...
                className="flex items-center gap-3 bg-indigo-600 text-white px-6 py-2 rounded-md hover:bg-indigo-700 active:scale-95 transition-all duration-200 shadow hover:shadow-md cursor-pointer"
              >
